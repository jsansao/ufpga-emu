...
int main(void)
{
    ...
    for (uint64_t t = 0; t <= MAX_TIME_US; t += HALF_PERIOD_US) {
        ...
        if (t == 0) check(t, "t=0", outputs, 165);
        if (t == 10) check(t, "t=10", outputs, 166);
        if (t == 20) check(t, "t=20", outputs, 161);
        if (t == 30) check(t, "t=30", outputs, 161);
        if (t == 40) check(t, "t=40", outputs, 85);
    }
