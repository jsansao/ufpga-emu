...
static const char *pinmap_json =
    ...
    "  {\"name\":\"b[0]\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"b[1]\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
    "  {\"name\":\"sel\",\"pin\":5,\"bit\":4,\"dir\":\"input\"},\n"
    "  {\"name\":\"y[0]\",\"pin\":6,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"y[1]\",\"pin\":7,\"bit\":1,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (mux2)\n");
