...
static const char *pinmap_json =
    ...
    "  {\"name\":\"out[0]\",\"pin\":5,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[1]\",\"pin\":6,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[2]\",\"pin\":7,\"bit\":2,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[3]\",\"pin\":8,\"bit\":3,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[4]\",\"pin\":9,\"bit\":4,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[5]\",\"pin\":10,\"bit\":5,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[6]\",\"pin\":11,\"bit\":6,\"dir\":\"output\"},\n"
    "  {\"name\":\"out[7]\",\"pin\":12,\"bit\":7,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (concat_multi)\n");
