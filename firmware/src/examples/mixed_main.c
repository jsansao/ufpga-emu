...
static const char *pinmap_json =
    ...
    "  {\"name\":\"a\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"b\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
    "  {\"name\":\"count[0]\",\"pin\":5,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[1]\",\"pin\":6,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"y\",\"pin\":7,\"bit\":2,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (mixed)\n");
