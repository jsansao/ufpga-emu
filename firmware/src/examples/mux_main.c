...
static const char *pinmap_json =
    "[\n"
    "  {\"name\":\"a\",\"pin\":1,\"bit\":0,\"dir\":\"input\"},\n"
    "  {\"name\":\"b\",\"pin\":2,\"bit\":1,\"dir\":\"input\"},\n"
    "  {\"name\":\"sel\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"y\",\"pin\":4,\"bit\":0,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (mux)\n");
