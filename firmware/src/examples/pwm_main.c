...
#define VCD_REG_COUNT 4

static const char *pinmap_json =
    "[\n"
    "  {\"name\":\"clk\",\"pin\":1,\"bit\":0,\"dir\":\"input\"},\n"
    "  {\"name\":\"rst\",\"pin\":2,\"bit\":1,\"dir\":\"input\"},\n"
    "  {\"name\":\"enable\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[0]\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[1]\",\"pin\":5,\"bit\":4,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[2]\",\"pin\":6,\"bit\":5,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[3]\",\"pin\":7,\"bit\":6,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[4]\",\"pin\":8,\"bit\":7,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[5]\",\"pin\":9,\"bit\":8,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[6]\",\"pin\":10,\"bit\":9,\"dir\":\"input\"},\n"
    "  {\"name\":\"duty[7]\",\"pin\":11,\"bit\":10,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[0]\",\"pin\":12,\"bit\":11,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[1]\",\"pin\":13,\"bit\":12,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[2]\",\"pin\":14,\"bit\":13,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[3]\",\"pin\":15,\"bit\":14,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[4]\",\"pin\":16,\"bit\":15,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[5]\",\"pin\":17,\"bit\":16,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[6]\",\"pin\":18,\"bit\":17,\"dir\":\"input\"},\n"
    "  {\"name\":\"period[7]\",\"pin\":19,\"bit\":18,\"dir\":\"input\"},\n"
    "  {\"name\":\"pwm_out\",\"pin\":20,\"bit\":0,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (pwm)\n");
