...
static const char *pinmap_json =
    "[\n"
    "  {\"name\":\"in[0]\",\"pin\":1,\"bit\":0,\"dir\":\"input\"},\n"
    "  {\"name\":\"in[1]\",\"pin\":2,\"bit\":1,\"dir\":\"input\"},\n"
    "  {\"name\":\"in[2]\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"in[3]\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (localparam_example)\n");
