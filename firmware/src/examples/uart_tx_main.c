...
#define VCD_REG_COUNT 8

static const char *pinmap_json =
    "[\n"
    "  {\"name\":\"clk\",\"pin\":1,\"bit\":0,\"dir\":\"input\"},\n"
    "  {\"name\":\"rst\",\"pin\":2,\"bit\":1,\"dir\":\"input\"},\n"
    "  {\"name\":\"send\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[0]\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[1]\",\"pin\":5,\"bit\":4,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[2]\",\"pin\":6,\"bit\":5,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[3]\",\"pin\":7,\"bit\":6,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[4]\",\"pin\":8,\"bit\":7,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[5]\",\"pin\":9,\"bit\":8,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[6]\",\"pin\":10,\"bit\":9,\"dir\":\"input\"},\n"
    "  {\"name\":\"data[7]\",\"pin\":11,\"bit\":10,\"dir\":\"input\"},\n"
    "  {\"name\":\"tx\",\"pin\":12,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"busy\",\"pin\":13,\"bit\":1,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (uart_tx)\n");
