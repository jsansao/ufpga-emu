...
static const char *pinmap_json =
    ...
    "  {\"name\":\"sum[0]\",\"pin\":9,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"sum[1]\",\"pin\":10,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"sum[2]\",\"pin\":11,\"bit\":2,\"dir\":\"output\"},\n"
    "  {\"name\":\"sum[3]\",\"pin\":12,\"bit\":3,\"dir\":\"output\"},\n"
    "  {\"name\":\"carry\",\"pin\":13,\"bit\":4,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (adder_n)\n");
