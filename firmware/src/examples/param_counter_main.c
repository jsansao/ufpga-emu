...
static const char *pinmap_json =
    ...
    "  {\"name\":\"count[0]\",\"pin\":3,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[1]\",\"pin\":4,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[2]\",\"pin\":5,\"bit\":2,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[3]\",\"pin\":6,\"bit\":3,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[4]\",\"pin\":7,\"bit\":4,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[5]\",\"pin\":8,\"bit\":5,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[6]\",\"pin\":9,\"bit\":6,\"dir\":\"output\"},\n"
    "  {\"name\":\"count[7]\",\"pin\":10,\"bit\":7,\"dir\":\"output\"},\n"
    "  {\"name\":\"overflow\",\"pin\":11,\"bit\":8,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (param_counter)\n");
