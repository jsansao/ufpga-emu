...
static const char *pinmap_json =
    ...
    "  {\"name\":\"result[0]\",\"pin\":21,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[1]\",\"pin\":22,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[2]\",\"pin\":23,\"bit\":2,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[3]\",\"pin\":24,\"bit\":3,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[4]\",\"pin\":25,\"bit\":4,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[5]\",\"pin\":26,\"bit\":5,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[6]\",\"pin\":27,\"bit\":6,\"dir\":\"output\"},\n"
    "  {\"name\":\"result[7]\",\"pin\":28,\"bit\":7,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (repeat_example)\n");
