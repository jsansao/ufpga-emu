...
static const char *pinmap_json =
    "[\n"
    "  {\"name\":\"req[0]\",\"pin\":1,\"bit\":0,\"dir\":\"input\"},\n"
    "  {\"name\":\"req[1]\",\"pin\":2,\"bit\":1,\"dir\":\"input\"},\n"
    "  {\"name\":\"req[2]\",\"pin\":3,\"bit\":2,\"dir\":\"input\"},\n"
    "  {\"name\":\"req[3]\",\"pin\":4,\"bit\":3,\"dir\":\"input\"},\n"
    "  {\"name\":\"code[0]\",\"pin\":5,\"bit\":0,\"dir\":\"output\"},\n"
    "  {\"name\":\"code[1]\",\"pin\":6,\"bit\":1,\"dir\":\"output\"},\n"
    "  {\"name\":\"valid\",\"pin\":7,\"bit\":2,\"dir\":\"output\"}\n"
    "]\n";
...
int main(void)
{
    ...
    telemetry_send_string("uFPGA-Emu v1.0 - PC Simulation (priority_encoder)\n");
