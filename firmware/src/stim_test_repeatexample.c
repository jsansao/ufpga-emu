...
int main(void)
{
    ...
    for (uint64_t t = 0; t <= MAX_TIME_US; t += HALF_PERIOD_US) {
        ...
        if (t == 5) check(t, "t=5", outputs, 8);
        if (t == 10) check(t, "t=10", outputs, 8);
        if (t == 15) check(t, "t=15", outputs, 12);
        if (t == 20) check(t, "t=20", outputs, 12);
        if (t == 25) check(t, "t=25", outputs, 1);
        if (t == 30) check(t, "t=30", outputs, 0);
    }
